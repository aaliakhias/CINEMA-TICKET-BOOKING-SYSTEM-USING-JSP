...
<%
                                 ...
                                 String mobile=request.getParameter("num1");
    ...
    ResultSet.CONCUR_READ_ONLY);
		...
		{ 
                ...
                String sql1="insert into custtranscation(custname,noofmovie,selectmovie,moneytopay,paymentmode,semoviename,mobile) values('"+custname+"','"+no1+"','"+selectmovie+"','"+mtop+"','"+mode1+"','"+mn+"','"+mobile+"')";
